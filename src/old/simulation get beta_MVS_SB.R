...
source("scripts/Scenarios.R") #Eventually should be gone!
...
saveRDS(beta_prev_0.05, file = paste0(scenario_1_settings,"Betas/Betas_prev_0.05_halfstrong.Rds"))
saveRDS(beta_prev_0.2, file = paste0(scenario_1_settings,"Betas/Betas_prev_0.2_halfstrong.Rds"))
